...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "India's athlete operating system — the fitness app Indian gym-goers have been waiting for. Track macros for dal, paneer, poha. Join 847+ athletes today." },
      { name: "twitter:description", content: "India's athlete operating system — the fitness app Indian gym-goers have been waiting for. Track macros for dal, paneer, poha. Join 847+ athletes today." },
